...
local gui = 
{
	paradoxLoader = Instance.new("ScreenGui"),
...
gui.paradoxLoader.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
gui.paradoxLoader.Name = "paradoxLoader"
gui.paradoxLoader.Parent = game:GetService("CoreGui")
...
gui.Frame.Parent = gui.paradoxLoader
...
gui.TextLabel.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
...
gui.TextLabel_1.TextColor3 = Color3.fromRGB(255, 0, 0)
...
gui.signin_load.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
...
gui.UIStroke.Color = Color3.fromRGB(255, 0, 0)
gui.UIStroke.Parent = gui.signin_load

gui.TextLabel_2.BorderSizePixel = 0
gui.TextLabel_2.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
...
gui.fps_checkbox.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
...
gui.UIStroke_1.Color = Color3.fromRGB(255, 0, 0)
gui.UIStroke_1.Parent = gui.fps_checkbox

gui.ImageLabel.BorderSizePixel = 0
gui.ImageLabel.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
gui.ImageLabel.Image = "http://www.roblox.com/asset/?id=3213"
...
gui.fpscheckbox_button.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
...
gui.paradoxLoader:Destroy()
    ...
    function Notifications(NotiINFO)
        if getgenv().NotiMode == "Roblox" then
            game:GetService("StarterGui"):SetCore("SendNotification",{
                Title = "paradox", -- Required
                Text = NotiINFO, -- Required
                Icon = "rbxassetid://16972905583" -- Optional
            })
        else
            ...
            if getgenv().NotiMode == "Akali" then
                ANotify({
                    ...
                    Kick('[paradox]: Notification Error, please contact support if this continues.')
        end
            end
                end
            end
    ...
    if game.PlaceId == 11883610532 or game.PlaceId == 12128125888 or game.PlaceId == 12543953865 then 
        print("[paradox]: Five Duels Detected")
    ...
    local WatermarkConnection = game:GetService('RunService').RenderStepped:Connect(function()
        ...
        Library:SetWatermark(('paradox.lol | %s fps | %s ms'):format(
            math.floor(FPS),
    ...
    local Unload2 = Unload1:AddButton({
        Text = 'Join Discord',
        Func = function()
            setclipboard("discord.gg/paradoxrbx")
            notifications:BuildNotificationUI();
    ...
    ThemeManager:SetFolder('paradoxlol-thm')
    SaveManager:SetFolder('paradoxlol-fd-cfg')
    ...
    Notifications("paradox is loading!");
    ...
    gui.Frame.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
    ...
    gui.Shadow.Image = "http://www.roblox.com/asset/?id=123"
    ...
    local Window = Library:CreateWindow({
        Title = 'paradox.lua | discord.gg/paradoxrbx',
        Center = true, 
        AutoShow = true,
        Size = UDim2.fromOffset(550, 560),
        TabPadding = 4,
...
--
    ...
    ThemeManager:SetFolder('paradoxlol-thm')
    SaveManager:SetFolder('paradoxlol-cfg')
